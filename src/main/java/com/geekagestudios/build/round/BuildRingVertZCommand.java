...
public class BuildRingVertZCommand extends CommandBase {
	...
	public String getCommandUsage(ICommandSender sender) {
		return "/build-ringvz [cX] [cY] [cZ] [radius] <thickness> <material> <border-material>";
	}

	@Override
	public void processCommand(ICommandSender sender, String[] args) throws CommandException {
		if(args.length >= 4) {
			new BuildRingVertZ(args).build(sender);
		} else {
